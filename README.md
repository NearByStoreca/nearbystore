...
emails the submission to **nearbystore.ca@gmail.com** and then redirects the visitor to
`thanks.html` on our own domain.

- **The destination is the endpoint**: `action="https://formsubmit.co/nearbystore.ca@gmail.com"`.
